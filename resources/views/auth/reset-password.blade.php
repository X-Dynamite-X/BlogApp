...
<div class="flex min-h-screen items-center justify-center p-6">
    <div class="w-full max-w-lg">
        ...
        <div class="mb-8 text-center">
            <h2 class="text-2xl font-semibold text-gray-900 dark:text-white">Reset Password</h2>
        ...
        <!-- Reset Password Form -->
        <form method="POST" action="{{ route('password.update') }}" class="space-y-6 rounded-xl bg-[#FDFDFC] p-8 shadow-lg transition-all duration-300 dark:bg-[#202020] dark:shadow-2xl">
            @csrf
