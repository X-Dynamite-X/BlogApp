    ...
    <div class="max-w-4xl mx-auto">
        ...
        <nav class="flex mb-8" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                <li class="inline-flex items-center">
                    <a href="{{ route('home') }}" class="inline-flex items-center text-gray-700 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-400">
        ...
        <div class="mb-8 bg-white dark:bg-[#202020] rounded-xl shadow-sm p-6">
            <div class="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p class="text-gray-600 dark:text-gray-400">Last updated: {{ $post->updated_at->diffForHumans() }}</p>
                </div>
                <div class="flex items-center space-x-4">
                    <a href="{{ route('post.show', $post) }}" class="inline-flex items-center px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
        ...
        <form action="{{ route('post.update', $post->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="bg-white dark:bg-[#202020] rounded-xl shadow-sm p-6">
                <div class="mb-4">
                    <label for="title" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Post Title</label>
                    <input type="text"
                           id="title"
                           name="title"
            ...
            <div class="bg-white dark:bg-[#202020] rounded-xl shadow-sm p-6">
                <div class="mb-4">
                    <label for="content" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Post Content</label>
                ...
                <div class="mb-6">
                    ...
                    <div class="relative group rounded-lg overflow-hidden">
                        ...
                        <div class="absolute inset-0 bg-black bg-opacity-40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                            <span class="text-white text-sm">Current post image</span>
                        </div>
                    </div>
                </div>
                @endif
...
<div id="deleteModal" class="fixed inset-0 z-50 hidden">
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
        <div class="bg-white dark:bg-gray-800 rounded-lg max-w-md w-full transform transition-all">
            <div class="p-6">
